...
/**
 * `GET /api/v1/transfer/jobs/{jobId}/errors` — download the
 * errors artifact (only exists for partially-succeeded imports).
 *
 * @category Transfer
 *
 * @since    0.1.0
 */
#[AsAction(name: 'transfer.jobs.errors')]
#[Get('/api/v1/transfer/jobs/{xferJob}/errors')]
...
final class DownloadErrors
{
    ...
    {
        return [
            'artifact_id' => (string) $xferJob->{XferJobInterface::ATTR_ERROR_ARTIFACT_ID},
        ];
    }
}
