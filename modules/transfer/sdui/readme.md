...
- `xfer-job-progress.widget.json` — progress bar with counter breakdown
  (created / updated / skipped / failed). Live-updates via the
  `user.{userId}.transfer` broadcast channel.
