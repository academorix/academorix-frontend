...
`NewsletterAudience` (segment definition). Consumes `academorix/notifications-
mail` for outbound delivery, enforces CAN-SPAM + CASL, ships one-click
unsubscribe via signed URL, per-issue open + click tracking, subscriber-growth
analytics, and sender-reputation guardrails. Priority `30` — loads after
