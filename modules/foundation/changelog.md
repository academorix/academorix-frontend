...
- **owns: 9 model traits** — HasSystemFlag, HasUserstamps, HasAuditable,
  HasMetadata (all already implicitly consumed by workspaces + invitations),
  plus Sortable, Filterable, Sluggable, Searchable, HasVectorEmbeddings (v2
  stub).
...
- **owns: base async primitives** — BaseJob (Sentry + workspaces context),
