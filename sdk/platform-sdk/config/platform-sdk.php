 ...
 *
 * @description
 * Runtime configuration for `academorix/platform-sdk`. Mirrors the shape of
...
return [
    ...
    |----------------------------------------------------------------
    */
    'base_url' => env('SDK_PLATFORM_BASE_URL', 'https://platform.academorix.test'),
    ...
    */
    'headers' => [
        ...
        'User-Agent'   => env('SDK_PLATFORM_USER_AGENT', 'academorix-platform-sdk/1.0'),
    ],
