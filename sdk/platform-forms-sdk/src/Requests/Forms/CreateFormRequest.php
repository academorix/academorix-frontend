...
use Academorix\PlatformFormsSdk\Payloads\Forms\CreateFormPayload;
 ...
 * @since    0.1.0
 */
final class CreateFormRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateFormPayload                $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateFormPayload $payload,
