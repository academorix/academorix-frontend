 ...
 *
 * @description
 * Runtime configuration for `academorix/billing-sdk`. Mirrors the shape of
...
return [
    ...
    |----------------------------------------------------------------
    */
    'base_url' => env('SDK_BILLING_BASE_URL', 'https://billing.academorix.test'),
    ...
    */
    'headers' => [
        ...
        'User-Agent'   => env('SDK_BILLING_USER_AGENT', 'academorix-billing-sdk/1.0'),
    ],
