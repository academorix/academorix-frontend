...
/**
 * `POST /api/v1/talent-flags` — create a TalentFlag.
 *
 * @category DevelopmentSdk
 *
 * @since    0.1.0
 */
final class CreateTalentFlagRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateTalentFlagPayload          $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateTalentFlagPayload $payload,
     ...
     * {@see TalentFlagData}.
     */
    public function createDtoFromResponse(Response $response): TalentFlagData
    {
        ...
        return TalentFlagData::from($body);
    }
}
