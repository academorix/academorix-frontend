...
/**
 * `GET /api/v1/expenses` — list every Expense.
 *
 * @category ExpensesSdk
 *
 * @since    0.1.0
 */
final class ListExpensesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): ExpenseData => ExpenseData::from($row),
                $items,
            ),
