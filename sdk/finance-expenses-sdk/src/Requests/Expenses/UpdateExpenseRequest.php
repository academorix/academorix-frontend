...
/**
 * `PATCH /api/v1/expenses/{expense}` — update one Expense.
 *
 * @category ExpensesSdk
 *
 * @since    0.1.0
 */
final class UpdateExpenseRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateExpensePayload             $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $expense,
        public readonly UpdateExpensePayload $payload,
