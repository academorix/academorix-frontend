...
/**
 * `GET /api/v1/platform/seasons/{season}` — show one Season.
 *
 * @category SeasonSdk
 *
 * @since    0.1.0
 */
final class ShowSeasonAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/seasons/' . rawurlencode($this->season);
    }
