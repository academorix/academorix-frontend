...
/**
 * `GET /api/v1/wallet-passes` — list every WalletPass.
 *
 * @category DigitalPassesSdk
 *
 * @since    0.1.0
 */
final class ListWalletPassesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<WalletPassData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): WalletPassData => WalletPassData::from($row),
                $items,
            ),
