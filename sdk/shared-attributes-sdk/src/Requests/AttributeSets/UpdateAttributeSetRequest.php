...
use Academorix\SharedAttributesSdk\Payloads\AttributeSets\UpdateAttributeSetPayload;
...
/**
 * `PATCH /api/v1/attribute-sets/{set}` — update one AttributeSet.
 *
 * @category AttributesSdk
 *
 * @since    0.1.0
 */
final class UpdateAttributeSetRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateAttributeSetPayload        $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $set,
        public readonly UpdateAttributeSetPayload $payload,
