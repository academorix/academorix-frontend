...
use Academorix\SharedAttributesSdk\Payloads\AttributeSets\CreateAttributeSetPayload;
...
/**
 * `POST /api/v1/attribute-sets` — create a AttributeSet.
 *
 * @category AttributesSdk
 *
 * @since    0.1.0
 */
final class CreateAttributeSetRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateAttributeSetPayload        $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateAttributeSetPayload $payload,
