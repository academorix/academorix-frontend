...
use Academorix\SharedAttributesSdk\Payloads\AttributeDefinitions\CreateAttributeDefinitionPayload;
...
/**
 * `POST /api/v1/attribute-definitions` — create a AttributeDefinition.
 *
 * @category AttributesSdk
 *
 * @since    0.1.0
 */
final class CreateAttributeDefinitionRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateAttributeDefinitionPayload $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateAttributeDefinitionPayload $payload,
