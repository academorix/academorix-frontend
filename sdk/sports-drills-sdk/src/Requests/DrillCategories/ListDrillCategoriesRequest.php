...
namespace Academorix\SportsDrillsSdk\Requests\DrillCategories;
...
/**
 * `GET /api/v1/drill-categories` — list every DrillCategory.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class ListDrillCategoriesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<DrillCategoryData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): DrillCategoryData => DrillCategoryData::from($row),
                $items,
            ),
