...
use Academorix\SportsDrillsSdk\Payloads\Drills\CreateDrillPayload;
...
/**
 * `POST /api/v1/drills` — create a Drill.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class CreateDrillRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateDrillPayload               $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateDrillPayload $payload,
