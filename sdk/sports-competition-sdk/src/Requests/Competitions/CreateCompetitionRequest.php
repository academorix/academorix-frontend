...
/**
 * `POST /api/v1/competitions` — create a Competition.
 *
 * @category CompetitionSdk
 *
 * @since    0.1.0
 */
final class CreateCompetitionRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateCompetitionPayload         $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateCompetitionPayload $payload,
