...
use Academorix\SportsRegistrationsSdk\Payloads\Registrations\UpdateRegistrationPayload;
...
/**
 * `PATCH /api/v1/registrations/{registration}` — update one Registration.
 *
 * @category RegistrationsSdk
 *
 * @since    0.1.0
 */
final class UpdateRegistrationRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateRegistrationPayload        $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $registration,
        public readonly UpdateRegistrationPayload $payload,
