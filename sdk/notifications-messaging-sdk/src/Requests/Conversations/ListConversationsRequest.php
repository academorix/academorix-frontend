...
/**
 * `GET /api/v1/conversations` — list every Conversation.
 *
 * @category MessagingSdk
 *
 * @since    0.1.0
 */
final class ListConversationsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): ConversationData => ConversationData::from($row),
                $items,
            ),
