...
/**
 * `GET /api/v1/platform/apps` — list every App.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class ListAppsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): AppData => AppData::from($row),
                $items,
            ),
