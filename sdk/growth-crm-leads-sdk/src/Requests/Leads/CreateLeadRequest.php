...
use Academorix\GrowthCrmLeadsSdk\Payloads\Leads\CreateLeadPayload;
 ...
 * @since    0.1.0
 */
final class CreateLeadRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateLeadPayload                $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateLeadPayload $payload,
