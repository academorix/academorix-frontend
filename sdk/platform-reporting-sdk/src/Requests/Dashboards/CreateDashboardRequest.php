...
use Academorix\PlatformReportingSdk\Payloads\Dashboards\CreateDashboardPayload;
 ...
 * @since    0.1.0
 */
final class CreateDashboardRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateDashboardPayload           $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateDashboardPayload $payload,
