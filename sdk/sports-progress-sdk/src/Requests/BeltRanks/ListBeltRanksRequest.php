...
namespace Academorix\SportsProgressSdk\Requests\BeltRanks;
...
/**
 * `GET /api/v1/belt-ranks` — list every BeltRank.
 *
 * @category ProgressSdk
 *
 * @since    0.1.0
 */
final class ListBeltRanksRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<BeltRankData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): BeltRankData => BeltRankData::from($row),
                $items,
            ),
