...
NEW = {
    ...
    "plu_": {"module": "platform-user", "entity": "PlatformUser", "description": "Stackra-staff principal on the `platform_admin` guard. Cross-tenant + cross-application by construction."},
    ...
    "rdf_": {"module": "rbac", "entity": "RoleDefinition", "description": "Stackra metadata layer for system roles - business_type default provisioning, i18n labels, min-tier gating."},
