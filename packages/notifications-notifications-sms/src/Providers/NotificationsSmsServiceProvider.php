...
namespace Academorix\Notifications\NotificationsSms\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `notifications-sms` module.
 *
...
final class NotificationsSmsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'notifications-sms');
    }
}
