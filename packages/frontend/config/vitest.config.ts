 ...
 * @description Vitest configuration for @stackra/config — merges the
 *   shared `@stackra/testing/preset` (SWC transform with decorator
 *   metadata support) and pins the Node.js environment.
 */
