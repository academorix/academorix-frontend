  ...
  return (
    ...
    >
      <header className="flex flex-col gap-1">
        <h1 className="text-foreground text-xl font-semibold">Notification preferences</h1>
      ...
      >
        <div className="flex flex-col gap-1">
          <h2 className="text-foreground text-base font-semibold">Browser push</h2>
          <p className="text-muted text-xs">
            Push notifications reach you when the app is closed or in the background.
          </p>
        </div>
        {!isSupported ? (
          <p className="text-muted text-sm">This browser doesn't support Web Push.</p>
        ) : permission === "default" ? (
          <div className="flex items-center justify-between gap-3">
            <p className="text-muted text-sm">Push is off. Enable it to get instant alerts.</p>
            <Button
              size="sm"
          ...
          <p className="text-success text-sm">Push is on for this browser.</p>
        )}
      </section>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-foreground text-base font-semibold">Do not disturb</h2>
        <div className="border-border bg-surface flex items-start justify-between gap-4 rounded-xl border p-3">
          <div className="flex min-w-0 flex-col">
            <span className="text-foreground text-sm font-medium">Global do-not-disturb</span>
      ...
      <section className="flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          <h2 className="text-foreground text-base font-semibold">Quiet hours</h2>
          <p className="text-muted text-sm">
