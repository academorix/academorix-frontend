...
namespace Academorix\Sports\Season\Data;
...
/**
 * Server-side output DTO for {@see \Academorix\Sports\Season\Models\Season}.
 *
 * Consumed by controllers + services on the SERVER side. This is
 * distinct from the wire SDK's DTO (which sits under
 * `Academorix\SportsSeasonSdk\Data`) — the wire DTO travels across the HTTP
