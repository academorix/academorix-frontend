...
namespace Academorix\Identity\ServiceAccounts\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `service-accounts` module.
 *
...
final class ServiceAccountsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'service-accounts');
    }
}
