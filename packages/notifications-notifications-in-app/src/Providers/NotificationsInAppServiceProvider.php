...
namespace Academorix\Notifications\NotificationsInApp\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `notifications-in-app` module.
 *
...
final class NotificationsInAppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'notifications-in-app');
    }
}
