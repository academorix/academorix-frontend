...
namespace Academorix\Notifications\NotificationsMail\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `notifications-mail` module.
 *
...
final class NotificationsMailServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'notifications-mail');
    }
}
