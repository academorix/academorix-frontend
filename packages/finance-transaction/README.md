# academorix-finance/transaction
...
- **TransactionLedgerEntry** (`tld_...`) — Double-entry line item.
- **Transaction** (`trx_...`) — The money-movement ledger root record.
