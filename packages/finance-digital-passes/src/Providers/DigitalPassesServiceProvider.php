...
namespace Academorix\Finance\DigitalPasses\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `digital-passes` module.
 *
...
final class DigitalPassesServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'digital-passes');
    }
}
