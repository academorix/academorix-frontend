...
namespace Academorix\Finance\DigitalPasses\Data;
...
/**
 * Server-side output DTO for {@see \Academorix\Finance\DigitalPasses\Models\WalletPass}.
 *
 * Consumed by controllers + services on the SERVER side. This is
 * distinct from the wire SDK's DTO (which sits under
 * `Academorix\FinanceDigitalPassesSdk\Data`) — the wire DTO travels across the HTTP
