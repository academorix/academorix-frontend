...
- **SessionAttendance** (`sat_...`) — Pivot row attaching an Athlete to a
  Session with attendance state.
- **Session** (`ses_...`) — A single practice / lesson / class instance.
