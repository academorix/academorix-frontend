...
- **CouponRedemption** (`crd_...`) — Per-use pivot connecting a Coupon to a
  specific target (Membership / Invoice / Transaction) via a specific customer
  (Use...
- **Coupon** (`cpn_...`) — Per-tenant discount code configuration.
