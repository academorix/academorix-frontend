...
- **AttributionTouchpoint** (`atp_...`) — Append-only ledger of every
  attribution-bearing request.
- **Attribution** (`att_...`) — Per-subject rolling attribution profile.
