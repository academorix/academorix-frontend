...
namespace Academorix\Sports\AthleteEnrollment\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `athlete-enrollment` module.
 *
...
final class AthleteEnrollmentServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'athlete-enrollment');
    }
}
