...
/**
 * Container Token Enumeration
 *
 * Defines the set of allowed values for Container Token within the Foundation module.
 ...
 *
 * @method static resolve() Returns the APP enum instance
