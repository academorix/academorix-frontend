 ...
 *
 * Defines the set of allowed values for Database Driver within the Foundation module.
 * Supported values include: MYSQL, MARIADB, PGSQL, SQLITE.
 *
 * @category Enums
 *
 * @since    1.0.0
 ...
 * ## Usage:
 * ```php
 * use Academorix\Foundation\Enums\DatabaseDriver;
 *
