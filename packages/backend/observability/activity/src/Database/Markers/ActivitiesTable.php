...
/**
 * @file Database/Markers/ActivitiesTable.php
 *
 * @description
 * Migration marker for the `activities` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ActivitiesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `activities`. The resolver uses this as a tiebreaker among
...
final class ActivitiesTable
{
    ...
    public const string MIGRATION = '2026_07_15_120001_create_activities_table.php';
