...
/**
 * @file Database/Markers/MonitoringAlertsTable.php
 *
 * @description
 * Migration marker for the `monitoring_alerts` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MonitoringAlertsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `monitoring_alerts`. The resolver uses this as a tiebreaker among
...
final class MonitoringAlertsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120003_create_monitoring_alerts_table.php';
