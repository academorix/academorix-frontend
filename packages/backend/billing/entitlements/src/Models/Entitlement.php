...
use Stackra\Entitlements\Casts\EntitlementValue;
use Stackra\Entitlements\Contracts\Data\EntitlementInterface;
use Stackra\Entitlements\Database\Factories\EntitlementFactory;
...
use Stackra\Entitlements\Observers\EntitlementObserver;
use Stackra\Entitlements\Policies\EntitlementPolicy;
...
final class Entitlement extends Model implements AuditableContract, EntitlementInterface
{
    ...
    public function usages(): HasMany
    {
        return $this->hasMany(
            ...
            \Stackra\Entitlements\Contracts\Data\EntitlementUsageInterface::ATTR_ENTITLEMENT_ID,
        );
    }
