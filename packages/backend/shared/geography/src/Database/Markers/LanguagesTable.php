...
/**
 * @file Database/Markers/LanguagesTable.php
 *
 * @description
 * Migration marker for the `languages` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(LanguagesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `languages`. The resolver uses this as a tiebreaker among
...
final class LanguagesTable
{
    ...
    public const string MIGRATION = '2026_07_15_120003_create_languages_table.php';
