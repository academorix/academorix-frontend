...
final readonly class BusinessTypesResource
{
     ...
     *
     * @throws \Stackra\ApiSdk\Exceptions\ResourceNotFoundException  When `$key` isn't in the catalogue.
     * @throws \Stackra\ApiSdk\Exceptions\ApiRequestException        The server responds `422 business_type_in_use` (also an ApiRequestException subclass) when a Workspace still references the key.
     */
