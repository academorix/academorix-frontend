...
/**
 * @file packages/backend/access/invitations/database/migrations/2026_07_22_000000_drop_application_id_from_invitations_table.php
 *
 * @description
 * Drop `application_id` from the `invitations` table per ADR-0031 §D3.
 *
 * The `invitations` row cascades through its legitimate parent — no attribution
...
return new class() extends Migration
{
    ...
    {
        Schema::table(InvitationInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->dropColumn(InvitationInterface::ATTR_APPLICATION_ID);
        });
    }
    ...
    public function down(): void
    {
        Schema::table(InvitationInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->index([InvitationInterface::ATTR_APPLICATION_ID]);
        });
    }
};
