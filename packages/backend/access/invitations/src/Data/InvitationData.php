...
namespace Stackra\Invitations\Data;
...
/**
 * Server-side output DTO for {@see \Stackra\Invitations\Models\Invitation}.
 *
 * Consumed by controllers + services on the SERVER side. This is
 * distinct from the wire SDK's DTO (which sits under
 * `Stackra\AccessInvitationsSdk\Data`) — the wire DTO travels across the HTTP
