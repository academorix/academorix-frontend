...
/**
 * @file modules/access/requests/src/Providers/RequestsServiceProvider.php
 *
 * @description
 * Root service provider for the Requests domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `RequestsPermissionSeeder` — projects `RequestsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Requests\Providers;
...
/**
 * Requests module service provider.
 *
 * Priority `18` places requests in the `access` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Requests', priority: 18)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
