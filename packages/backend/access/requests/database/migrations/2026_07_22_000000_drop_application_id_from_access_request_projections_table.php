...
/**
 * @file packages/backend/access/requests/database/migrations/2026_07_22_000000_drop_application_id_from_access_request_projections_table.php
 *
 * @description
 * Drop `application_id` from the `access_request_projections` table per ADR-0031 §D3.
 *
 * The `access_request_projections` row cascades through its legitimate parent — no attribution
...
return new class() extends Migration
{
    ...
    {
        Schema::table(AccessRequestProjectionInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->dropColumn(AccessRequestProjectionInterface::ATTR_APPLICATION_ID);
        });
    }
    ...
    public function down(): void
    {
        Schema::table(AccessRequestProjectionInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->uuid(AccessRequestProjectionInterface::ATTR_APPLICATION_ID)->nullable();
            $table->index([AccessRequestProjectionInterface::ATTR_APPLICATION_ID]);
        });
    }
};
