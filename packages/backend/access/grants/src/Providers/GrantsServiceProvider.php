...
/**
 * @file modules/access/grants/src/Providers/GrantsServiceProvider.php
 *
 * @description
 * Root service provider for the Grants domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `GrantsPermissionSeeder` — projects `GrantsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Grants\Providers;
...
/**
 * Grants module service provider.
 *
 * Priority `18` places grants in the `access` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Grants', priority: 18)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class GrantsServiceProvider extends ServiceProvider
{
}
