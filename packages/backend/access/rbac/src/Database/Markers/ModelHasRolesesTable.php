...
/**
 * @file Database/Markers/ModelHasRolesesTable.php
 *
 * @description
 * Migration marker for the `model_has_roleses` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ModelHasRolesesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `model_has_roleses`. The resolver uses this as a tiebreaker among
...
final class ModelHasRolesesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120001_create_model_has_roleses_table.php';
