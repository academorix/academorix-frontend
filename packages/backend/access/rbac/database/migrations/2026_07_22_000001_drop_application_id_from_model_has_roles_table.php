...
/**
 * @file packages/backend/access/rbac/database/migrations/2026_07_22_000001_drop_application_id_from_model_has_roles_table.php
 *
 * @description
 * Drop `application_id` from the `model_has_roles` table per ADR-0031 §D3.
 *
 * The `model_has_roles` row cascades through its legitimate parent — no attribution
...
return new class() extends Migration
{
    ...
    {
        Schema::table(ModelHasRolesInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->dropColumn(ModelHasRolesInterface::ATTR_APPLICATION_ID);
        });
    }
    ...
    public function down(): void
    {
        Schema::table(ModelHasRolesInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->uuid(ModelHasRolesInterface::ATTR_APPLICATION_ID)->nullable();
            $table->index([ModelHasRolesInterface::ATTR_APPLICATION_ID]);
        });
    }
};
