...
/**
 * @file packages/backend/access/rbac/database/migrations/2026_07_22_000002_drop_application_id_from_role_has_permissions_table.php
 *
 * @description
 * Drop `application_id` from the `role_has_permissions` table per ADR-0031 §D3.
 *
 * The `role_has_permissions` row cascades through its legitimate parent — no attribution
...
return new class() extends Migration
{
    ...
    {
        Schema::table(RoleHasPermissionsInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->dropColumn(RoleHasPermissionsInterface::ATTR_APPLICATION_ID);
        });
    }
    ...
    public function down(): void
    {
        Schema::table(RoleHasPermissionsInterface::TABLE, function (Blueprint $table): void {
            ...
            $table->uuid(RoleHasPermissionsInterface::ATTR_APPLICATION_ID)->nullable();
            $table->index([RoleHasPermissionsInterface::ATTR_APPLICATION_ID]);
        });
    }
};
