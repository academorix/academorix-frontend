...
/**
 * @file Database/Markers/ImpersonationSessionsTable.php
 *
 * @description
 * Migration marker for the `impersonation_sessions` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ImpersonationSessionsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `impersonation_sessions`. The resolver uses this as a tiebreaker among
...
final class ImpersonationSessionsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_impersonation_sessions_table.php';
