...
/**
 * Split Browser Renderer
 *
 * Support class providing Split Browser Renderer utilities for the Omniterm module.
 ...
 * @since    1.0.0
 */
namespace Academorix\OmniTerm\Browser;

use Academorix\OmniTerm\Async\SplitBrowser;
use Academorix\OmniTerm\Helpers\Partials\AsciiHelper;
use Academorix\OmniTerm\Rendering\Ansi;
