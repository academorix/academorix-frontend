...
/**
 * Seeder for the `hierarchy.organizations` flag.
 *
...
final class HierarchyOrganizationsFlagSeeder extends Seeder
{
    /**
    ...
    /**
     * Seed the `hierarchy.organizations` catalog row.
     *
     * @return void
     */
    public function run(): void
    {
        $this->features->factory()->create([
            FeatureInterface::ATTR_NAME        => 'hierarchy.organizations',
            FeatureInterface::ATTR_DESCRIPTION => 'Optional Organizations layer in the tenant hierarchy.',
