...
/**
 * Has Query Modifiers Trait
 *
 * Provides Query Modifiers capabilities to models and classes that use this trait.
 * Encapsulates reusable Query Modifiers logic for the Framework module.
 *
 * @category Concerns
 *
 * @since    1.0.0
