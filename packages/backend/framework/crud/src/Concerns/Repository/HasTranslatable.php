...
/**
 * Has Translatable Trait
 *
 * Provides Translatable capabilities to models and classes that use this trait.
 * Encapsulates reusable Translatable logic for the Framework module.
 *
 * @category Concerns
 *
 * @since    1.0.0
