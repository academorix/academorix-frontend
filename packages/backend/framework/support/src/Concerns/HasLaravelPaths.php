...
/**
 * Has Laravel Paths Trait
 *
 * Provides Laravel Paths capabilities to models and classes that use this trait.
 * Encapsulates reusable Laravel Paths logic for the Framework module.
 *
 * @category Concerns
 *
 * @since    1.0.0
