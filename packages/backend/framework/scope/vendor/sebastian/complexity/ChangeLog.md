...
- [#7](https://github.com/sebastianbergmann/complexity/pull/7):
  `ComplexityCalculatingVisitor` tries to process interface methods
...
- The `ParentConnectingVisitor` has been removed (it should have been marked as
  `@internal`)
...
[1.0.0]:
  https://github.com/sebastianbergmann/complexity/compare/70ee0ad32d9e2be3f85beffa3e2eb474193f2487...1.0.0
