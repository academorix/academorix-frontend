...
/**
 * `GET /api/v1/app-installations` — list action (tenant audience).
 *
 ...
 * @since    0.1.0
 */
#[AsAction(name: 'integrations.app_installations.list')]
#[Get('/api/v1/app-installations')]
#[Middleware(['api', 'auth:sanctum', 'tenant.resolve'])]
final class ListAppInstallationAction
{
    use AsController;
    ...
    /**
     * List `app-installations` for the current caller.
     *
     ...
     *
     * @return PaginatedDataCollection<int, AppInstallationData>  Paginated wire-visible DTOs.
     */
    public function __invoke(Request $request): PaginatedDataCollection
    {
        ...
        return AppInstallationData::collect($page, PaginatedDataCollection::class);
    }
}
