...
/**
 * `DELETE /api/v1/tenant/webhook/subscriptions/{id}` — soft-delete a
 * subscription. Cascades to `webhook_deliveries` at the DB layer.
 *
 * @category Webhook
 *
 * @since    0.1.0
 */
#[AsAction(name: 'webhook.tenant.subscriptions.delete')]
