...
/**
 * @file modules/platform/realtime/src/Providers/RealtimeServiceProvider.php
 *
 * @description
 * Root service provider for the Realtime domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `RealtimePermissionSeeder` — projects `RealtimePermission` cases into spatie/laravel-permission.
...
namespace Academorix\Realtime\Providers;
...
/**
 * Realtime module service provider.
 *
 * Priority `12` places realtime in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Realtime', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
