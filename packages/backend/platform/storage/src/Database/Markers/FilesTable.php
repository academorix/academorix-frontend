...
final class FilesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_000060_create_files_table.php';
