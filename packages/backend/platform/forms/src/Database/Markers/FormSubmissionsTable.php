...
/**
 * @file Database/Markers/FormSubmissionsTable.php
 *
 * @description
 * Migration marker for the `form_submissions` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(FormSubmissionsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `form_submissions`. The resolver uses this as a tiebreaker among
...
final class FormSubmissionsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_form_submissions_table.php';
