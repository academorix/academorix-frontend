...
/**
 * @file Database/Markers/SavedReportsTable.php
 *
 * @description
 * Migration marker for the `saved_reports` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(SavedReportsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `saved_reports`. The resolver uses this as a tiebreaker among
...
final class SavedReportsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120003_create_saved_reports_table.php';
