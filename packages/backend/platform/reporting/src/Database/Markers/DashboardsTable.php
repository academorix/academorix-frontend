...
/**
 * @file Database/Markers/DashboardsTable.php
 *
 * @description
 * Migration marker for the `dashboards` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(DashboardsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `dashboards`. The resolver uses this as a tiebreaker among
...
final class DashboardsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_dashboards_table.php';
