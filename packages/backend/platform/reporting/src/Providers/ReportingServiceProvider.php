...
/**
 * @file modules/platform/reporting/src/Providers/ReportingServiceProvider.php
 *
 * @description
 * Root service provider for the Reporting domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `ReportingPermissionSeeder` — projects `ReportingPermission` cases into spatie/laravel-permission.
...
/**
 * Reporting module service provider.
 *
 * Priority `12` places reporting in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Reporting', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
