...
namespace Stackra\Ai\Registry;

use Stackra\Ai\Contracts\Registry\ToolRegistryInterface;
use Illuminate\Container\Attributes\Scoped;
use Stackra\Ai\Contracts\Repositories\AiConversationRepositoryInterface;

/**
 * Concrete service — ToolRegistry.
 *
 * Implements {@see ToolRegistryInterface}. `#[Scoped]` because most
