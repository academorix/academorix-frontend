...
namespace Stackra\Branch\Database\Markers;
...
final class BranchesTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_branches_table.php';
