...
/**
 * @file Database/Markers/OrganizationsTable.php
 *
 * @description
 * Migration marker for the `organizations` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(OrganizationsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `organizations`. The resolver uses this as a tiebreaker among
...
namespace Stackra\Organization\Database\Markers;
...
final class OrganizationsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_organizations_table.php';
