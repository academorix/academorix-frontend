...
/**
 * @file modules/platform/admin-console/src/Providers/AdminConsoleServiceProvider.php
 *
 * @description
 * Root service provider for the AdminConsole domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AdminConsolePermissionSeeder` — projects `AdminConsolePermission` cases into spatie/laravel-permission.
...
namespace Academorix\AdminConsole\Providers;
...
/**
 * AdminConsole module service provider.
 *
 * Priority `12` places admin-console in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'AdminConsole', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class AdminConsoleServiceProvider extends ServiceProvider
{
}
