...
/**
 * @file Database/Markers/FacilitiesTable.php
 *
 * @description
 * Migration marker for the `facilities` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(FacilitiesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `facilities`. The resolver uses this as a tiebreaker among
...
final class FacilitiesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120001_create_facilities_table.php';
