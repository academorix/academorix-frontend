...
namespace Stackra\Region\Database\Markers;
...
final class RegionsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_regions_table.php';
