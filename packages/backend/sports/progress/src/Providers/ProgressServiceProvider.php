...
/**
 * @file modules/sports/progress/src/Providers/ProgressServiceProvider.php
 *
 * @description
 * Root service provider for the Progress domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `ProgressPermissionSeeder` — projects `ProgressPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Progress\Providers;
...
/**
 * Progress module service provider.
 *
 * Priority `40` places progress in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Progress', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
