...
/**
 * @file modules/sports/drills/src/Providers/DrillsServiceProvider.php
 *
 * @description
 * Root service provider for the Drills domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `DrillsPermissionSeeder` — projects `DrillsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Drills\Providers;
...
/**
 * Drills module service provider.
 *
 * Priority `40` places drills in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Drills', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class DrillsServiceProvider extends ServiceProvider
{
}
