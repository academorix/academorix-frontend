...
/**
 * @file modules/sports/athlete/src/Providers/AthleteServiceProvider.php
 *
 * @description
 * Root service provider for the Athlete domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AthletePermissionSeeder` — projects `AthletePermission` cases into spatie/laravel-permission.
...
namespace Academorix\Athlete\Providers;
...
/**
 * Athlete module service provider.
 *
 * Priority `40` places athlete in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Athlete', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
