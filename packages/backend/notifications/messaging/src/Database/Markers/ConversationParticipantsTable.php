...
/**
 * @file Database/Markers/ConversationParticipantsTable.php
 *
 * @description
 * Migration marker for the `conversation_participants` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ConversationParticipantsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `conversation_participants`. The resolver uses this as a tiebreaker among
...
namespace Stackra\Messaging\Database\Markers;

use Stackra\Database\Attributes\DependsOn;

final class ConversationParticipantsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_conversation_participants_table.php';
