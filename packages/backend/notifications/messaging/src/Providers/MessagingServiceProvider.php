...
/**
 * @file modules/notifications/messaging/src/Providers/MessagingServiceProvider.php
 *
 * @description
 * Root service provider for the Messaging domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `MessagingPermissionSeeder` — projects `MessagingPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Messaging\Providers;
...
/**
 * Messaging module service provider.
 *
 * Priority `25` places messaging in the `notifications` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Messaging', priority: 25)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
