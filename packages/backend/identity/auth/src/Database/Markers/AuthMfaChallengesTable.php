...
/**
 * @file Database/Markers/AuthMfaChallengesTable.php
 *
 * @description
 * Migration marker for the `auth_mfa_challenges` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(AuthMfaChallengesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `auth_mfa_challenges`. The resolver uses this as a tiebreaker among
...
final class AuthMfaChallengesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120004_create_auth_mfa_challenges_table.php';
