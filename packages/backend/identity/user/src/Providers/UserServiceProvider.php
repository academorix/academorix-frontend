...
/**
 * @file modules/identity/user/src/Providers/UserServiceProvider.php
 *
 * @description
 * Root service provider for the User domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `UserPermissionSeeder` — projects `UserPermission` cases into spatie/laravel-permission.
...
namespace Academorix\User\Providers;
 ...
 *
 * Priority `8` places user in the `identity` tier
