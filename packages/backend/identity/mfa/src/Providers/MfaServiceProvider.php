...
/**
 * @file modules/identity/mfa/src/Providers/MfaServiceProvider.php
 *
 * @description
 * Root service provider for the Mfa domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `MfaPermissionSeeder` — projects `MfaPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Mfa\Providers;
...
/**
 * Mfa module service provider.
 *
 * Priority `8` places mfa in the `identity` tier
