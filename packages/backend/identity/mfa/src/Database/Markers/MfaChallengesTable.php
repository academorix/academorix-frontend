...
/**
 * @file Database/Markers/MfaChallengesTable.php
 *
 * @description
 * Migration marker for the `mfa_challenges` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MfaChallengesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `mfa_challenges`. The resolver uses this as a tiebreaker among
...
final class MfaChallengesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_mfa_challenges_table.php';
