...
/**
 * @file Database/Markers/DsarArtefactsTable.php
 *
 * @description
 * Migration marker for the `dsar_artefacts` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(DsarArtefactsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `dsar_artefacts`. The resolver uses this as a tiebreaker among
...
final class DsarArtefactsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_000303_create_dsar_artefacts_table.php';
