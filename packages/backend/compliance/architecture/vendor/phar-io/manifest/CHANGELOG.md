...
All notable changes to phar-io/manifest are documented in this file using the
...
- Do not use implict nullable type (thanks @sebastianbergmann), this should make
  things work on PHP 8.4
...
- Upgraded to phar-io/version 3.0
  - Version strings `v1.2.3` will now be converted to valid semantic version
    strings `1.2.3`
