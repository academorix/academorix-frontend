...
- [#21](https://github.com/sebastianbergmann/version/pull/21): Avoid spawning a
  shell for Git
...
- [#17](https://github.com/sebastianbergmann/version/pull/17): Release archive
  contains unnecessary assets
