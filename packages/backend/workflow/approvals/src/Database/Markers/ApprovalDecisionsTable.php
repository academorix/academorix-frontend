...
/**
 * @file Database/Markers/ApprovalDecisionsTable.php
 *
 * @description
 * Migration marker for the `approval_decisions` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ApprovalDecisionsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `approval_decisions`. The resolver uses this as a tiebreaker among
...
final class ApprovalDecisionsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120001_create_approval_decisions_table.php';
