...
namespace Academorix\Notifications\NotificationsPush\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `notifications-push` module.
 *
...
final class NotificationsPushServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'notifications-push');
    }
}
