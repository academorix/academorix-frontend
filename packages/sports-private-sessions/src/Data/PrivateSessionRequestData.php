...
namespace Academorix\Sports\PrivateSessions\Data;
...
/**
 * Server-side output DTO for {@see \Academorix\Sports\PrivateSessions\Models\PrivateSessionRequest}.
 *
 * Consumed by controllers + services on the SERVER side. This is
 * distinct from the wire SDK's DTO (which sits under
 * `Academorix\SportsPrivateSessionsSdk\Data`) — the wire DTO travels across the HTTP
