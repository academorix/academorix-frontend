...
namespace Academorix\Sports\PrivateSessions\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the `private-sessions` module.
 *
...
final class PrivateSessionsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../../lang', 'private-sessions');
    }
}
