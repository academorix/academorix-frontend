...
/**
 * `POST /api/v1/curriculums` — create a Curriculum.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class CreateCurriculumRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateCurriculumPayload          $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateCurriculumPayload $payload,
     ...
     * {@see CurriculumData}.
     */
    public function createDtoFromResponse(Response $response): CurriculumData
    {
        ...
        return CurriculumData::from($body);
    }
}
