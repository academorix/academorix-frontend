...
/**
 * `POST /api/v1/background-checks` — create a BackgroundCheck.
 *
 * @category SafeguardingSdk
 *
 * @since    0.1.0
 */
final class CreateBackgroundCheckRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateBackgroundCheckPayload     $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateBackgroundCheckPayload $payload,
    ...
    {
        return '/api/v1/background-checks';
    }
