...
/**
 * `GET /api/v1/platform/credentials` — list every Credential.
 *
 * @category CredentialsSdk
 *
 * @since    0.1.0
 */
final class ListCredentialsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/credentials';
    }
     ...
     * `PaginatedResponse<CredentialData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): CredentialData => CredentialData::from($row),
                $items,
            ),
