...
/**
 * Wire-visible response DTO for {@see \App\Models\Budget}.
 *
 * Mirrors `schemas/budget.schema.json` column-for-column, minus
 ...
 *
 * $row = app(FinanceSdk::class)->expenses()->budgets()->show($id);
 * ```
 *
