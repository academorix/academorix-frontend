...
namespace Academorix\FinanceExpensesSdk\Requests\ExpenseCategories;
...
/**
 * `GET /api/v1/expense-categories` — list every ExpenseCategory.
 *
 * @category ExpensesSdk
 *
 * @since    0.1.0
 */
final class ListExpenseCategoriesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<ExpenseCategoryData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): ExpenseCategoryData => ExpenseCategoryData::from($row),
                $items,
            ),
