...
- **cost-centers** — CostCenter entity.
- **expense-categories** — ExpenseCategory entity.
- **expenses** — Expense entity.
- **payroll-lines** — Per-staff line in a PayrollRun
- **payroll-runs** — PayrollRun entity.

## Layout

```
src/
├── ExpensesSdkResource.php     # #[AsSdkResource] — the entry point
...
This SDK is regenerated from the blueprint at `modules/finance/expenses/`. Do
...
```
python3 modules/shared/blueprints/foundation/scripts/generate-sdk.py finance expenses
```
