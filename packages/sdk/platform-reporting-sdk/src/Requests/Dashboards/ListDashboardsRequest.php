...
/**
 * `GET /api/v1/dashboards` — list every Dashboard.
 *
 * @category ReportingSdk
 *
 * @since    0.1.0
 */
final class ListDashboardsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): DashboardData => DashboardData::from($row),
                $items,
            ),
