...
use Academorix\PlatformReportingSdk\Payloads\Dashboards\UpdateDashboardPayload;
...
/**
 * `PATCH /api/v1/dashboards/{dashboard}` — update one Dashboard.
 *
 * @category ReportingSdk
 *
 * @since    0.1.0
 */
final class UpdateDashboardRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateDashboardPayload           $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $dashboard,
        public readonly UpdateDashboardPayload $payload,
