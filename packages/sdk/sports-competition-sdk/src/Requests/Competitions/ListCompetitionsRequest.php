...
/**
 * `GET /api/v1/competitions` — list every Competition.
 *
 * @category CompetitionSdk
 *
 * @since    0.1.0
 */
final class ListCompetitionsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<CompetitionData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): CompetitionData => CompetitionData::from($row),
                $items,
            ),
