...
/**
 * Wire-visible response DTO for {@see \App\Models\StandingRow}.
 *
 * Mirrors `schemas/standing-row.schema.json` column-for-column, minus
 ...
 *
 * $row = app(SportsSdk::class)->competition()->standingRows()->show($id);
 * ```
 *
