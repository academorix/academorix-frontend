...
use Academorix\NotificationsMessagingSdk\Payloads\Conversations\CreateConversationPayload;
 ...
 * @since    0.1.0
 */
final class CreateConversationRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateConversationPayload        $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateConversationPayload $payload,
