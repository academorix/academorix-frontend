...
/**
 * `GET /api/v1/talent-flags` — list every TalentFlag.
 *
 * @category DevelopmentSdk
 *
 * @since    0.1.0
 */
final class ListTalentFlagsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<TalentFlagData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): TalentFlagData => TalentFlagData::from($row),
                $items,
            ),
