...
/**
 * `GET /api/v1/pathway-stages` — list every PathwayStage.
 *
 * @category DevelopmentSdk
 *
 * @since    0.1.0
 */
final class ListPathwayStagesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<PathwayStageData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PathwayStageData => PathwayStageData::from($row),
                $items,
            ),
