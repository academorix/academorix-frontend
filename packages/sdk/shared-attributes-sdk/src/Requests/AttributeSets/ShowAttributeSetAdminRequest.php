...
/**
 * `GET /api/v1/platform/attribute-sets/{set}` — show one AttributeSet.
 *
 * @category AttributesSdk
 *
 * @since    0.1.0
 */
final class ShowAttributeSetAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/attribute-sets/' . rawurlencode($this->set);
    }
