...
/**
 * `GET /api/v1/platform/attribute-sets` — list every AttributeSet.
 *
 * @category AttributesSdk
 *
 * @since    0.1.0
 */
final class ListAttributeSetsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/attribute-sets';
    }
     ...
     * `PaginatedResponse<AttributeSetData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): AttributeSetData => AttributeSetData::from($row),
                $items,
            ),
