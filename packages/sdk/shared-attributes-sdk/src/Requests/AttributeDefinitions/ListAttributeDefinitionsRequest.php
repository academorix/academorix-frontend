...
/**
 * `GET /api/v1/attribute-definitions` — list every AttributeDefinition.
 *
 * @category AttributesSdk
 *
 * @since    0.1.0
 */
final class ListAttributeDefinitionsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<AttributeDefinitionData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): AttributeDefinitionData => AttributeDefinitionData::from($row),
                $items,
            ),
