...
/**
 * Wire-visible response DTO for {@see \App\Models\Award}.
 *
 * Mirrors `schemas/award.schema.json` column-for-column, minus
 ...
 *
 * $row = app(SportsSdk::class)->awards()->awards()->show($id);
 * ```
 *
 * @category AwardsSdk
 *
