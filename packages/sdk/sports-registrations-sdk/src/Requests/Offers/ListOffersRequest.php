...
namespace Academorix\SportsRegistrationsSdk\Requests\Offers;
...
/**
 * `GET /api/v1/offers` — list every Offer.
 *
 * @category RegistrationsSdk
 *
 * @since    0.1.0
 */
final class ListOffersRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): OfferData => OfferData::from($row),
                $items,
            ),
