...
/**
 * `GET /api/v1/platform/integration-providers` — list every IntegrationProvider.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class ListIntegrationProvidersAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/integration-providers';
    }
     ...
     * `PaginatedResponse<IntegrationProviderData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): IntegrationProviderData => IntegrationProviderData::from($row),
                $items,
            ),
