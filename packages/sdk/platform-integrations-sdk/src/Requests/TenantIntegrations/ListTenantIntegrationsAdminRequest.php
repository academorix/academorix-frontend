...
/**
 * `GET /api/v1/platform/tenant-integrations` — list every TenantIntegration.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class ListTenantIntegrationsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/tenant-integrations';
    }
     ...
     * `PaginatedResponse<TenantIntegrationData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): TenantIntegrationData => TenantIntegrationData::from($row),
                $items,
            ),
