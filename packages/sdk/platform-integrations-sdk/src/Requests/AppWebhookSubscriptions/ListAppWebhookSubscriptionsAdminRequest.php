...
/**
 * `GET /api/v1/platform/app-webhook-subscriptions` — list every AppWebhookSubscription.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class ListAppWebhookSubscriptionsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/app-webhook-subscriptions';
    }
     ...
     * `PaginatedResponse<AppWebhookSubscriptionData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): AppWebhookSubscriptionData => AppWebhookSubscriptionData::from($row),
                $items,
            ),
