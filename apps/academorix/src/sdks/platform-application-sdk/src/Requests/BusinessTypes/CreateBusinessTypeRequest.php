...
/**
 * @file apps/academorix/src/sdks/platform-application-sdk/src/Requests/BusinessTypes/CreateBusinessTypeRequest.php
 *
 * @description
 ...
 * `data/business-types.json` + `config/tenants.php` and
