 ...
 * `config/tenants.php`, and served through the same admin surface
 ...
 * tenant provisioning time (features / terminology / seeded roles
...
{
    /**
     * @param  string                                                       $key                 Enum key — also the value written to `tenants.business_type`.
     ...
     *     sports?: list<string>
     * }                                                                    $defaultConfig       Bag applied at tenant provisioning time — features + terminology + seeded roles + entitlements + onboarding steps + sports.
