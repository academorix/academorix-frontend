...
/**
 * Wire-visible response DTO for {@see \App\Models\AiToolCall}.
 *
 * Mirrors `schemas/ai-tool-call.schema.json` column-for-column, minus
 ...
 *
 * $row = app(PlatformSdk::class)->ai()->aiToolCalls()->show($id);
 * ```
 *
 * @category AiSdk
 *
