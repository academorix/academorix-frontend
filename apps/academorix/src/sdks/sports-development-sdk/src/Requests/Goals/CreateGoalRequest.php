...
use Academorix\SportsDevelopmentSdk\Payloads\Goals\CreateGoalPayload;
 ...
 * @since    0.1.0
 */
final class CreateGoalRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateGoalPayload                $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateGoalPayload $payload,
