...
/**
 * `GET /api/v1/platform/scouting-reports` — list every ScoutingReport.
 *
 * @category DevelopmentSdk
 *
 * @since    0.1.0
 */
final class ListScoutingReportsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/scouting-reports';
    }
     ...
     * `PaginatedResponse<ScoutingReportData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): ScoutingReportData => ScoutingReportData::from($row),
                $items,
            ),
