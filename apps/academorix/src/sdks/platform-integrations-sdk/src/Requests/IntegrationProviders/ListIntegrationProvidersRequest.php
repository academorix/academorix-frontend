...
/**
 * `GET /api/v1/integration-providers` — list every IntegrationProvider.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class ListIntegrationProvidersRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/integration-providers';
    }
