...
/**
 * `PATCH /api/v1/tenant-integrations/{integration}` — update one TenantIntegration.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class UpdateTenantIntegrationRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateTenantIntegrationPayload   $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $integration,
        public readonly UpdateTenantIntegrationPayload $payload,
