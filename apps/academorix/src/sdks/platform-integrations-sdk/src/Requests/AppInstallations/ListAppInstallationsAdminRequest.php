...
/**
 * `GET /api/v1/platform/app-installations` — list every AppInstallation.
 *
 * @category IntegrationsSdk
 *
 * @since    0.1.0
 */
final class ListAppInstallationsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/app-installations';
    }
     ...
     * `PaginatedResponse<AppInstallationData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): AppInstallationData => AppInstallationData::from($row),
                $items,
            ),
