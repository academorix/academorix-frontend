...
use Academorix\SportsProgressSdk\Payloads\ProgressAssessments\UpdateProgressAssessmentPayload;
...
/**
 * `PATCH /api/v1/progress-assessments/{assessment}` — update one ProgressAssessment.
 *
 * @category ProgressSdk
 *
 * @since    0.1.0
 */
final class UpdateProgressAssessmentRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateProgressAssessmentPayload  $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $assessment,
        public readonly UpdateProgressAssessmentPayload $payload,
