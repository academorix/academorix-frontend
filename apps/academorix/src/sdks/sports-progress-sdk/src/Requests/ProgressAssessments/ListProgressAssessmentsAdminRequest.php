...
/**
 * `GET /api/v1/platform/progress-assessments` — list every ProgressAssessment.
 *
 * @category ProgressSdk
 *
 * @since    0.1.0
 */
final class ListProgressAssessmentsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/progress-assessments';
    }
     ...
     * `PaginatedResponse<ProgressAssessmentData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): ProgressAssessmentData => ProgressAssessmentData::from($row),
                $items,
            ),
