...
/**
 * `GET /api/v1/platform/grading-events` — list every GradingEvent.
 *
 * @category ProgressSdk
 *
 * @since    0.1.0
 */
final class ListGradingEventsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/grading-events';
    }
     ...
     * `PaginatedResponse<GradingEventData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): GradingEventData => GradingEventData::from($row),
                $items,
            ),
