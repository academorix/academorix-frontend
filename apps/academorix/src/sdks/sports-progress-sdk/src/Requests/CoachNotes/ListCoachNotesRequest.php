...
/**
 * `GET /api/v1/coach-notes` — list every CoachNote.
 *
 * @category ProgressSdk
 *
 * @since    0.1.0
 */
final class ListCoachNotesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<CoachNoteData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): CoachNoteData => CoachNoteData::from($row),
                $items,
            ),
