...
/**
 * Wire-visible response DTO for {@see \App\Models\CoachNote}.
 *
 * Mirrors `schemas/coach-note.schema.json` column-for-column, minus
 ...
 *
 * $row = app(SportsSdk::class)->progress()->coachNotes()->show($id);
 * ```
 *
...
final class CoachNoteData extends Data
{
    /**
     * @param  string                       $id
