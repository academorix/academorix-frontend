...
/**
 * `GET /api/v1/forms` — list every Form.
 *
 * @category FormsSdk
 *
 * @since    0.1.0
 */
final class ListFormsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): FormData => FormData::from($row),
                $items,
            ),
