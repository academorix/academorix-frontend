...
/**
 * `GET /api/v1/session-plans` — list every SessionPlan.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class ListSessionPlansRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<SessionPlanData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): SessionPlanData => SessionPlanData::from($row),
                $items,
            ),
