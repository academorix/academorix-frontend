...
/**
 * `GET /api/v1/curriculums` — list every Curriculum.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class ListCurriculumsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<CurriculumData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): CurriculumData => CurriculumData::from($row),
                $items,
            ),
