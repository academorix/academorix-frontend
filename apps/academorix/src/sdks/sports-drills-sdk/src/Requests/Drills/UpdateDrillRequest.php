...
use Academorix\SportsDrillsSdk\Payloads\Drills\UpdateDrillPayload;
...
/**
 * `PATCH /api/v1/drills/{drill}` — update one Drill.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class UpdateDrillRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
     ...
     * @param  UpdateDrillPayload               $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly string $drill,
        public readonly UpdateDrillPayload $payload,
