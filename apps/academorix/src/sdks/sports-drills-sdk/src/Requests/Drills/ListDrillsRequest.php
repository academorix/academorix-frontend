...
/**
 * `GET /api/v1/drills` — list every Drill.
 *
 * @category DrillsSdk
 *
 * @since    0.1.0
 */
final class ListDrillsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): DrillData => DrillData::from($row),
                $items,
            ),
