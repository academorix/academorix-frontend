 ...
 * @since    0.1.0
 */
final class CreateSeasonRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateSeasonPayload              $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateSeasonPayload $payload,
