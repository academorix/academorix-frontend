...
/**
 * `GET /api/v1/trial-bookings` — list every TrialBooking.
 *
 * @category RegistrationsSdk
 *
 * @since    0.1.0
 */
final class ListTrialBookingsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<TrialBookingData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): TrialBookingData => TrialBookingData::from($row),
                $items,
            ),
