...
/**
 * `GET /api/v1/registrations` — list every Registration.
 *
 * @category RegistrationsSdk
 *
 * @since    0.1.0
 */
final class ListRegistrationsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<RegistrationData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): RegistrationData => RegistrationData::from($row),
                $items,
            ),
