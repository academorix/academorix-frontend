...
/**
 * `GET /api/v1/public-pages` — list every PublicPage.
 *
 * @category PublicSiteSdk
 *
 * @since    0.1.0
 */
final class ListPublicPagesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<PublicPageData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PublicPageData => PublicPageData::from($row),
                $items,
            ),
