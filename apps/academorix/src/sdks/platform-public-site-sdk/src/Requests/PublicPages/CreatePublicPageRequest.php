...
use Academorix\PlatformPublicSiteSdk\Payloads\PublicPages\CreatePublicPagePayload;
...
/**
 * `POST /api/v1/public-pages` — create a PublicPage.
 *
 * @category PublicSiteSdk
 *
 * @since    0.1.0
 */
final class CreatePublicPageRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreatePublicPagePayload          $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreatePublicPagePayload $payload,
