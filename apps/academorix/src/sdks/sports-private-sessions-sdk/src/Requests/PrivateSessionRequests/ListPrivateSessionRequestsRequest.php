...
/**
 * `GET /api/v1/private-session-requests` — list every PrivateSessionRequest.
 *
 * @category PrivateSessionsSdk
 *
 * @since    0.1.0
 */
final class ListPrivateSessionRequestsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<PrivateSessionRequestData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PrivateSessionRequestData => PrivateSessionRequestData::from($row),
                $items,
            ),
