...
namespace Academorix\SportsAwardsSdk\Data;
...
/**
 * Wire-visible response DTO for {@see \App\Models\Certificate}.
 *
 * Mirrors `schemas/certificate.schema.json` column-for-column, minus
 ...
 *
 * $row = app(SportsSdk::class)->awards()->certificates()->show($id);
 * ```
 *
 * @category AwardsSdk
 *
