...
/**
 * `GET /api/v1/test-batteries` — list every TestBattery.
 *
 * @category PerformanceSdk
 *
 * @since    0.1.0
 */
final class ListTestBatteriesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<TestBatteryData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): TestBatteryData => TestBatteryData::from($row),
                $items,
            ),
