...
/**
 * `POST /api/v1/performance-test-results` — create a PerformanceTestResult.
 *
 * @category PerformanceSdk
 *
 * @since    0.1.0
 */
final class CreatePerformanceTestResultRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreatePerformanceTestResultPayload $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreatePerformanceTestResultPayload $payload,
    ...
    {
        return '/api/v1/performance-test-results';
    }
     ...
     * {@see PerformanceTestResultData}.
     */
    public function createDtoFromResponse(Response $response): PerformanceTestResultData
    {
        ...
        return PerformanceTestResultData::from($body);
    }
}
