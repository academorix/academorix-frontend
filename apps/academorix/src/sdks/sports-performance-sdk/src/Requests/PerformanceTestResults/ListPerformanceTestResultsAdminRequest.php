...
/**
 * `GET /api/v1/platform/performance-test-results` — list every PerformanceTestResult.
 *
 * @category PerformanceSdk
 *
 * @since    0.1.0
 */
final class ListPerformanceTestResultsAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/performance-test-results';
    }
     ...
     * `PaginatedResponse<PerformanceTestResultData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PerformanceTestResultData => PerformanceTestResultData::from($row),
                $items,
            ),
