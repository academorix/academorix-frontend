...
namespace Academorix\SportsPerformanceSdk\Requests\Benchmarks;
...
/**
 * `GET /api/v1/platform/benchmarks` — list every Benchmark.
 *
 * @category PerformanceSdk
 *
 * @since    0.1.0
 */
final class ListBenchmarksAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/benchmarks';
    }
     ...
     * `PaginatedResponse<BenchmarkData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): BenchmarkData => BenchmarkData::from($row),
                $items,
            ),
