...
/**
 * `GET /api/v1/performance-tests` — list every PerformanceTest.
 *
 * @category PerformanceSdk
 *
 * @since    0.1.0
 */
final class ListPerformanceTestsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<PerformanceTestData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PerformanceTestData => PerformanceTestData::from($row),
                $items,
            ),
