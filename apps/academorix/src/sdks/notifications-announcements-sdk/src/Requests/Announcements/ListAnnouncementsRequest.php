...
/**
 * `GET /api/v1/announcements` — list every Announcement.
 *
 * @category AnnouncementsSdk
 *
 * @since    0.1.0
 */
final class ListAnnouncementsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<AnnouncementData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): AnnouncementData => AnnouncementData::from($row),
                $items,
            ),
