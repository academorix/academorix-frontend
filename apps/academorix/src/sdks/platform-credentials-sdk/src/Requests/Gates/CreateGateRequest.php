 ...
 * @since    0.1.0
 */
final class CreateGateRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateGatePayload                $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateGatePayload $payload,
     ...
     * {@see GateData}.
     */
    public function createDtoFromResponse(Response $response): GateData
    {
