...
/**
 * `GET /api/v1/platform/gates` — list every Gate.
 *
 * @category CredentialsSdk
 *
 * @since    0.1.0
 */
final class ListGatesAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): GateData => GateData::from($row),
                $items,
            ),
