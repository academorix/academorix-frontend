...
/**
 * `GET /api/v1/medical-clearances` — list every MedicalClearance.
 *
 * @category MedicalSdk
 *
 * @since    0.1.0
 */
final class ListMedicalClearancesRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<MedicalClearanceData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): MedicalClearanceData => MedicalClearanceData::from($row),
                $items,
            ),
