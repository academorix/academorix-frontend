...
/**
 * `POST /api/v1/athletes/{athlete}/injuries` — custom — custom endpoint (hand-implement).
 *
 * @category MedicalSdk
 *
 * @since    0.1.0
 */
final class InjuriesInjuryRequest extends BaseSdkRequest implements HasBody
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/athletes/' . rawurlencode($this->athlete) . '/injuries';
    }
