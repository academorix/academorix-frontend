...
/**
 * Wire-visible response DTO for {@see \App\Models\Allergy}.
 *
 * Mirrors `schemas/allergy.schema.json` column-for-column, minus
 ...
 *
 * $row = app(SportsSdk::class)->medical()->allergies()->show($id);
 * ```
 *
 * @category MedicalSdk
 *
...
final class AllergyData extends Data
{
    /**
     * @param  string                       $id
