...
/**
 * `GET /api/v1/policy-acknowledgements` — list every PolicyAcknowledgement.
 *
 * @category SafeguardingSdk
 *
 * @since    0.1.0
 */
final class ListPolicyAcknowledgementsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/policy-acknowledgements';
    }
     ...
     * `PaginatedResponse<PolicyAcknowledgementData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PolicyAcknowledgementData => PolicyAcknowledgementData::from($row),
                $items,
            ),
