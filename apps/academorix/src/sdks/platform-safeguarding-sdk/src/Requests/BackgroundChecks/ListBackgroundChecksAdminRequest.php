...
/**
 * `GET /api/v1/platform/background-checks` — list every BackgroundCheck.
 *
 * @category SafeguardingSdk
 *
 * @since    0.1.0
 */
final class ListBackgroundChecksAdminRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    {
        return '/api/v1/platform/background-checks';
    }
     ...
     * `PaginatedResponse<BackgroundCheckData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): BackgroundCheckData => BackgroundCheckData::from($row),
                $items,
            ),
