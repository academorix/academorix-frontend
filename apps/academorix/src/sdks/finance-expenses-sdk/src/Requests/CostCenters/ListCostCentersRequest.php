...
namespace Academorix\FinanceExpensesSdk\Requests\CostCenters;
...
/**
 * `GET /api/v1/cost-centers` — list every CostCenter.
 *
 * @category ExpensesSdk
 *
 * @since    0.1.0
 */
final class ListCostCentersRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<CostCenterData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): CostCenterData => CostCenterData::from($row),
                $items,
            ),
