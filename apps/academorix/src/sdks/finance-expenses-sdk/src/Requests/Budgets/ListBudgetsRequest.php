...
namespace Stackra\FinanceExpensesSdk\Requests\Budgets;
...
/**
 * `GET /api/v1/budgets` — list every Budget.
 *
 * @category ExpensesSdk
 *
 * @since    0.1.0
 */
final class ListBudgetsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): BudgetData => BudgetData::from($row),
                $items,
            ),
