...
namespace Stackra\FinanceExpensesSdk\Requests\PayrollRuns;
...
/**
 * `GET /api/v1/payroll-runs` — list every PayrollRun.
 *
 * @category ExpensesSdk
 *
 * @since    0.1.0
 */
final class ListPayrollRunsRequest extends BaseSdkRequest
{
    /**
     * HTTP verb.
     */
     ...
     * `PaginatedResponse<PayrollRunData>`.
     *
    ...
    public function createDtoFromResponse(Response $response): PaginatedResponse
    {
        ...
        return new PaginatedResponse(
            data: array_map(
                static fn (array $row): PayrollRunData => PayrollRunData::from($row),
                $items,
            ),
