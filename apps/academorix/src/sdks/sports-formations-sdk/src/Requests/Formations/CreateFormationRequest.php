...
use Academorix\SportsFormationsSdk\Payloads\Formations\CreateFormationPayload;
...
/**
 * `POST /api/v1/formations` — create a Formation.
 *
 * @category FormationsSdk
 *
 * @since    0.1.0
 */
final class CreateFormationRequest extends BaseSdkRequest implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  CreateFormationPayload           $payload         Validated payload.
     * @param  string|null  $idempotencyKey  Optional idempotency token.
     */
    public function __construct(
        public readonly CreateFormationPayload $payload,
