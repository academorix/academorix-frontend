...
/**
 * @file modules/finance/expenses/src/Providers/ExpensesServiceProvider.php
 *
 * @description
 * Root service provider for the Expenses domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `ExpensesPermissionSeeder` — projects `ExpensesPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Expenses\Providers;
...
/**
 * Expenses module service provider.
 *
 * Priority `30` places expenses in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Expenses', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
