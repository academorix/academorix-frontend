...
/**
 * `GET /api/v1/expense-categories` — list action (tenant audience).
 *
 ...
 * @since    0.1.0
 */
#[AsAction(name: 'expenses.expense_categories.list')]
#[Get('/api/v1/expense-categories')]
#[Middleware(['api', 'auth:sanctum', 'tenant.resolve'])]
final class ListExpenseCategorieAction
{
    use AsController;
    ...
    /**
     * List `expense-categories` for the current caller.
     *
     ...
     *
     * @return PaginatedDataCollection<int, ExpenseCategoryData>  Paginated wire-visible DTOs.
     */
    public function __invoke(Request $request): PaginatedDataCollection
    {
        ...
        return ExpenseCategoryData::collect($page, PaginatedDataCollection::class);
    }
}
