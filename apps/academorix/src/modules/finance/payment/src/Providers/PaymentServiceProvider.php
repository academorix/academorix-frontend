...
/**
 * @file modules/finance/payment/src/Providers/PaymentServiceProvider.php
 *
 * @description
 * Root service provider for the Payment domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `PaymentPermissionSeeder` — projects `PaymentPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Payment\Providers;
 ...
 *
 * Priority `30` places payment in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Payment', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
