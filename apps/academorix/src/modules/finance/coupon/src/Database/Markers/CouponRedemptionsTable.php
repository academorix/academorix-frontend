...
/**
 * @file Database/Markers/CouponRedemptionsTable.php
 *
 * @description
 * Migration marker for the `coupon_redemptions` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(CouponRedemptionsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `coupon_redemptions`. The resolver uses this as a tiebreaker among
...
namespace Academorix\Coupon\Database\Markers;

use Stackra\Database\Attributes\DependsOn;

final class CouponRedemptionsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_coupon_redemptions_table.php';
