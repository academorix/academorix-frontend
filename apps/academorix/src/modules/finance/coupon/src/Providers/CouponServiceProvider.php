...
/**
 * @file modules/finance/coupon/src/Providers/CouponServiceProvider.php
 *
 * @description
 * Root service provider for the Coupon domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `CouponPermissionSeeder` — projects `CouponPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Coupon\Providers;
...
/**
 * Coupon module service provider.
 *
 * Priority `30` places coupon in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Coupon', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
