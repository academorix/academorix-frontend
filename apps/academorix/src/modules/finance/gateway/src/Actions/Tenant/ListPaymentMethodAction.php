...
/**
 * `GET /api/v1/payment-methods` — list action (tenant audience).
 *
 ...
 * @since    0.1.0
 */
#[AsAction(name: 'gateway.payment_methods.list')]
#[Get('/api/v1/payment-methods')]
#[Middleware(['api', 'auth:sanctum', 'tenant.resolve'])]
final class ListPaymentMethodAction
{
    use AsController;
    ...
    /**
     * List `payment-methods` for the current caller.
     *
     ...
     *
     * @return PaginatedDataCollection<int, PaymentMethodData>  Paginated wire-visible DTOs.
     */
    public function __invoke(Request $request): PaginatedDataCollection
    {
        ...
        return PaymentMethodData::collect($page, PaginatedDataCollection::class);
    }
}
