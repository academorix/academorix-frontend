...
/**
 * @file Database/Markers/WalletTransactionsTable.php
 *
 * @description
 * Migration marker for the `wallet_transactions` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(WalletTransactionsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `wallet_transactions`. The resolver uses this as a tiebreaker among
...
namespace Academorix\Wallet\Database\Markers;
...
final class WalletTransactionsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120001_create_wallet_transactions_table.php';
