...
/**
 * @file Database/Markers/WalletHoldsTable.php
 *
 * @description
 * Migration marker for the `wallet_holds` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(WalletHoldsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `wallet_holds`. The resolver uses this as a tiebreaker among
...
final class WalletHoldsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_wallet_holds_table.php';
