...
/**
 * @file Database/Markers/CreditNotesTable.php
 *
 * @description
 * Migration marker for the `credit_notes` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(CreditNotesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `credit_notes`. The resolver uses this as a tiebreaker among
...
final class CreditNotesTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_credit_notes_table.php';
