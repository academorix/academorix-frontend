...
/**
 * @file modules/finance/tax/src/Providers/TaxServiceProvider.php
 *
 * @description
 * Root service provider for the Tax domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `TaxPermissionSeeder` — projects `TaxPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Tax\Providers;
...
/**
 * Tax module service provider.
 *
 * Priority `30` places tax in the `finance` tier
