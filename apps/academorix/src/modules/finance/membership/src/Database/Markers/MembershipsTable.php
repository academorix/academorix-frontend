...
/**
 * @file Database/Markers/MembershipsTable.php
 *
 * @description
 * Migration marker for the `memberships` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MembershipsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `memberships`. The resolver uses this as a tiebreaker among
...
final class MembershipsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120002_create_memberships_table.php';
