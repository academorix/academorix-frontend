...
/**
 * @file Database/Markers/MembershipPlansTable.php
 *
 * @description
 * Migration marker for the `membership_plans` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MembershipPlansTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `membership_plans`. The resolver uses this as a tiebreaker among
...
final class MembershipPlansTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_membership_plans_table.php';
