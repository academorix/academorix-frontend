...
/**
 * @file Database/Markers/MembershipRenewalsTable.php
 *
 * @description
 * Migration marker for the `membership_renewals` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MembershipRenewalsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `membership_renewals`. The resolver uses this as a tiebreaker among
...
final class MembershipRenewalsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120001_create_membership_renewals_table.php';
