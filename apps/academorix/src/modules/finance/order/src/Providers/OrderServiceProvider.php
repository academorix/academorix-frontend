...
/**
 * @file modules/finance/order/src/Providers/OrderServiceProvider.php
 *
 * @description
 * Root service provider for the Order domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `OrderPermissionSeeder` — projects `OrderPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Order\Providers;
...
/**
 * Order module service provider.
 *
 * Priority `30` places order in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Order', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
