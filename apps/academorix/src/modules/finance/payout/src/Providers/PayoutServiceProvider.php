...
/**
 * @file modules/finance/payout/src/Providers/PayoutServiceProvider.php
 *
 * @description
 * Root service provider for the Payout domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `PayoutPermissionSeeder` — projects `PayoutPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Payout\Providers;
...
/**
 * Payout module service provider.
 *
 * Priority `30` places payout in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Payout', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
