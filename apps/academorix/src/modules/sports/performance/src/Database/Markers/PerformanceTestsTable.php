...
/**
 * @file Database/Markers/PerformanceTestsTable.php
 *
 * @description
 * Migration marker for the `performance_tests` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(PerformanceTestsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `performance_tests`. The resolver uses this as a tiebreaker among
...
final class PerformanceTestsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120002_create_performance_tests_table.php';
