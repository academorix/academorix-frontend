...
/**
 * @file Database/Markers/MedicalRecordsTable.php
 *
 * @description
 * Migration marker for the `medical_records` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MedicalRecordsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `medical_records`. The resolver uses this as a tiebreaker among
...
final class MedicalRecordsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120003_create_medical_records_table.php';
