...
/**
 * @file modules/sports/medical/src/Providers/MedicalServiceProvider.php
 *
 * @description
 * Root service provider for the Medical domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `MedicalPermissionSeeder` — projects `MedicalPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Medical\Providers;
...
/**
 * Medical module service provider.
 *
 * Priority `40` places medical in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Medical', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class MedicalServiceProvider extends ServiceProvider
{
}
