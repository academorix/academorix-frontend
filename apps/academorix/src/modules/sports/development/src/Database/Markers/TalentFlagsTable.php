...
/**
 * @file Database/Markers/TalentFlagsTable.php
 *
 * @description
 * Migration marker for the `talent_flags` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(TalentFlagsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `talent_flags`. The resolver uses this as a tiebreaker among
...
final class TalentFlagsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120004_create_talent_flags_table.php';
