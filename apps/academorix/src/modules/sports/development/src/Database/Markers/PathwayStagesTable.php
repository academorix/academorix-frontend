...
/**
 * @file Database/Markers/PathwayStagesTable.php
 *
 * @description
 * Migration marker for the `pathway_stages` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(PathwayStagesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `pathway_stages`. The resolver uses this as a tiebreaker among
...
final class PathwayStagesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120002_create_pathway_stages_table.php';
