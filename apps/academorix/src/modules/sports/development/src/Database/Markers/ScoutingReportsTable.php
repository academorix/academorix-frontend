...
/**
 * @file Database/Markers/ScoutingReportsTable.php
 *
 * @description
 * Migration marker for the `scouting_reports` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ScoutingReportsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `scouting_reports`. The resolver uses this as a tiebreaker among
...
namespace Academorix\Development\Database\Markers;

use Stackra\Database\Attributes\DependsOn;

final class ScoutingReportsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120003_create_scouting_reports_table.php';
