...
/**
 * @file modules/sports/coaching/src/Providers/CoachingServiceProvider.php
 *
 * @description
 * Root service provider for the Coaching domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `CoachingPermissionSeeder` — projects `CoachingPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Coaching\Providers;
...
/**
 * Coaching module service provider.
 *
 * Priority `40` places coaching in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Coaching', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
