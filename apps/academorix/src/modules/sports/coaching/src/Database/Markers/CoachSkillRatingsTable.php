...
/**
 * @file Database/Markers/CoachSkillRatingsTable.php
 *
 * @description
 * Migration marker for the `coach_skill_ratings` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(CoachSkillRatingsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `coach_skill_ratings`. The resolver uses this as a tiebreaker among
...
final class CoachSkillRatingsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120002_create_coach_skill_ratings_table.php';
