...
/**
 * @file Database/Markers/MatchParticipantsTable.php
 *
 * @description
 * Migration marker for the `match_participants` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(MatchParticipantsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `match_participants`. The resolver uses this as a tiebreaker among
...
final class MatchParticipantsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120003_create_match_participants_table.php';
