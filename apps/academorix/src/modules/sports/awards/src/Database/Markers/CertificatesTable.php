...
/**
 * @file Database/Markers/CertificatesTable.php
 *
 * @description
 * Migration marker for the `certificates` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(CertificatesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `certificates`. The resolver uses this as a tiebreaker among
...
namespace Academorix\Awards\Database\Markers;
...
final class CertificatesTable
{
    ...
    public const string MIGRATION = '2026_07_15_120001_create_certificates_table.php';
