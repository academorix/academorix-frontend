...
/**
 * @file modules/sports/awards/src/Providers/AwardsServiceProvider.php
 *
 * @description
 * Root service provider for the Awards domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AwardsPermissionSeeder` — projects `AwardsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Awards\Providers;
...
/**
 * Awards module service provider.
 *
 * Priority `40` places awards in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Awards', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class AwardsServiceProvider extends ServiceProvider
{
}
