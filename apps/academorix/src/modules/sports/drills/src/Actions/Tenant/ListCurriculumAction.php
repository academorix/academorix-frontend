...
/**
 * `GET /api/v1/curriculums` — list action (tenant audience).
 *
 ...
 * @since    0.1.0
 */
#[AsAction(name: 'drills.curriculums.list')]
#[Get('/api/v1/curriculums')]
#[Middleware(['api', 'auth:sanctum', 'tenant.resolve'])]
final class ListCurriculumAction
{
    use AsController;
    ...
    /**
     * List `curriculums` for the current caller.
     *
     ...
     *
     * @return PaginatedDataCollection<int, CurriculumData>  Paginated wire-visible DTOs.
     */
    public function __invoke(Request $request): PaginatedDataCollection
    {
        ...
        return CurriculumData::collect($page, PaginatedDataCollection::class);
    }
}
