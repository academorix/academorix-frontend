 ...
 *
 * Implements {@see AbsenceThresholdEvaluatorInterface}. `#[Scoped]` because most
 ...
 */
#[Scoped]
final class AbsenceThresholdEvaluator implements AbsenceThresholdEvaluatorInterface
{
    /**
