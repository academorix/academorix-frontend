...
/**
 * @file Database/Markers/AttendancePoliciesTable.php
 *
 * @description
 * Migration marker for the `attendance_policies` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(AttendancePoliciesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `attendance_policies`. The resolver uses this as a tiebreaker among
...
final class AttendancePoliciesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120001_create_attendance_policies_table.php';
