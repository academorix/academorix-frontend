...
namespace Academorix\Season\Database\Markers;

use Stackra\Database\Attributes\DependsOn;

final class SeasonsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_seasons_table.php';
