...
/**
 * @file Database/Markers/FormationSlotsTable.php
 *
 * @description
 * Migration marker for the `formation_slots` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(FormationSlotsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `formation_slots`. The resolver uses this as a tiebreaker among
...
final class FormationSlotsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_formation_slots_table.php';
