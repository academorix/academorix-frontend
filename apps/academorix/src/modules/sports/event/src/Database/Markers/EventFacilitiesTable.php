...
/**
 * @file Database/Markers/EventFacilitiesTable.php
 *
 * @description
 * Migration marker for the `event_facilities` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(EventFacilitiesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `event_facilities`. The resolver uses this as a tiebreaker among
...
final class EventFacilitiesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120001_create_event_facilities_table.php';
