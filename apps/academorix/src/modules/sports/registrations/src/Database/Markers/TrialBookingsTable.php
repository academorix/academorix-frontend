...
/**
 * @file Database/Markers/TrialBookingsTable.php
 *
 * @description
 * Migration marker for the `trial_bookings` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(TrialBookingsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `trial_bookings`. The resolver uses this as a tiebreaker among
...
final class TrialBookingsTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120004_create_trial_bookings_table.php';
