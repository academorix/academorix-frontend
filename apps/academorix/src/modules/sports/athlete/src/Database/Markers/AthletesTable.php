...
namespace Academorix\Athlete\Database\Markers;

use Stackra\Database\Attributes\DependsOn;

final class AthletesTable
{
    /** Migration file that produces this table. */
    public const string MIGRATION = '2026_07_15_120000_create_athletes_table.php';
