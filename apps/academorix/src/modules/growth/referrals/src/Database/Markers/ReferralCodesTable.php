...
/**
 * @file Database/Markers/ReferralCodesTable.php
 *
 * @description
 * Migration marker for the `referral_codes` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ReferralCodesTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `referral_codes`. The resolver uses this as a tiebreaker among
...
final class ReferralCodesTable
{
    ...
    public const string MIGRATION = '2026_07_15_120000_create_referral_codes_table.php';
