...
/**
 * @file Database/Markers/ReferralsTable.php
 *
 * @description
 * Migration marker for the `referrals` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ReferralsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `referrals`. The resolver uses this as a tiebreaker among
...
final class ReferralsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120004_create_referrals_table.php';
