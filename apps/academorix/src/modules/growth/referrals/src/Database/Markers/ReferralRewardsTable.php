...
/**
 * @file Database/Markers/ReferralRewardsTable.php
 *
 * @description
 * Migration marker for the `referral_rewards` table. Discovered at boot by
 * {@see \Stackra\Database\Migrations\MigrationDagResolver} —
 * every downstream marker that references THIS one via
 * `#[DependsOn(ReferralRewardsTable::class)]` must run AFTER the migration
 * named in the MIGRATION constant.
 *
 * ## What this marker declares
 *
 *   * `MIGRATION` — the timestamped migration file that CREATES
 *     `referral_rewards`. The resolver uses this as a tiebreaker among
...
final class ReferralRewardsTable
{
    ...
    public const string MIGRATION = '2026_07_15_120003_create_referral_rewards_table.php';
