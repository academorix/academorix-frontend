 ...
 * (`phase3` for deep-link + global-shortcut, `phase4` for the
 * updater); the SPA build reaches for them via dynamic `import(...)`
 * and catches the resolution failure at runtime.
 *
