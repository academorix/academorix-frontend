...
Aim for under 10 lines per method. Extract business logic to action or service
classes.
...
Type-hinting Form Requests triggers automatic validation and authorization
