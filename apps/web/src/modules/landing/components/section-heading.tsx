 ...
 * @module modules/landing/components/section-heading
 *
 * @description
 * Shared, centered heading block used by the marketing sections (features,
 * sports, how-it-works, pricing, testimonials). Standardises the eyebrow →
 * `<h2>` → description rhythm and wires the `<h2>` `id` used by each section's
 * `aria-labelledby`, keeping heading hierarchy and spacing consistent.
 */
 ...
 *
 * @param props - Heading content and the `<h2>` id for labelling.
 */
