...
import type { Athlete, EntityStatus, SkillLevel } from "@/types";
import type { Key, ReactNode } from "react";

import { ENTITY_STATUSES, ENTITY_STATUS_LABELS, SKILL_LEVELS, SKILL_LEVEL_LABELS } from "@/types";
...
export function toAthletePayload(values: AthleteFormValues): Partial<Athlete> {
  ...
  return {
    ...
    team_id: emptyToNull(values.team_id),
        ...
        <Card.Content>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Select
              ...
              variant="secondary"
              onChange={(key: Key | null) => setField("level", (key as SkillLevel | null) ?? "")}
            >
              <Label>Level</Label>
              <Select.Trigger>
                <Select.Value />
