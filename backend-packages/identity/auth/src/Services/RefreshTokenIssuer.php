...
use Academorix\Auth\Contracts\Services\RefreshTokenIssuerInterface;
use Illuminate\Container\Attributes\Scoped;
use Academorix\Auth\Contracts\Repositories\AuthCrossAppGrantRepositoryInterface;

/**
 * Concrete service — RefreshTokenIssuer.
 *
 * Implements {@see RefreshTokenIssuerInterface}. `#[Scoped]` because most
