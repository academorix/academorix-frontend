...
namespace Academorix\Identity\Database\Seeders;

use Academorix\Identity\Enums\IdentityPermission;
...
/**
 * Seed the {@see IdentityPermission} cases into spatie/laravel-permission's
 * `permissions` table.
 *
...
final class IdentityPermissionSeeder extends Seeder
{
    ...
    {
        return [IdentityPermission::class];
    }
}
