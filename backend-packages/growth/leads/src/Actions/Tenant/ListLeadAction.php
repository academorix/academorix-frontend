...
/**
 * `GET /api/v1/leads` — list action (tenant audience).
 *
...
final class ListLeadAction
{
    ...
    /**
     * List `leads` for the current caller.
     *
     ...
     *
     * @return PaginatedDataCollection<int, LeadData>  Paginated wire-visible DTOs.
     */
    public function __invoke(Request $request): PaginatedDataCollection
    {
        ...
        return LeadData::collect($page, PaginatedDataCollection::class);
    }
}
