...
namespace Academorix\Leads\Database\Seeders;
...
/**
 * Seed the {@see LeadsPermission} cases into spatie/laravel-permission's
 * `permissions` table.
 *
...
final class LeadsPermissionSeeder extends Seeder
{
