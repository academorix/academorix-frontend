...
/**
 * Policy Ability Enumeration
 *
 * Defines the set of allowed values for Policy Ability within the Foundation module.
 ...
 *
 * ```php
 * use Academorix\Foundation\Attributes\Auth\Authorize;
