 ...
 *
 * Defines the set of allowed values for Filesystem Driver within the Foundation module.
 * Supported values include: LOCAL, S3, FTP, SFTP.
 *
 * @category Enums
 *
 * @since    1.0.0
 ...
 * ## Usage:
 * ```php
 * use Academorix\Foundation\Enums\FilesystemDriver;
 *
