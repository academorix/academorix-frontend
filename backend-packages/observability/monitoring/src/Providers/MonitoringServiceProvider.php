...
/**
 * @file modules/observability/monitoring/src/Providers/MonitoringServiceProvider.php
 *
 * @description
 * Root service provider for the Monitoring domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `MonitoringPermissionSeeder` — projects `MonitoringPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Monitoring\Providers;
...
/**
 * Monitoring module service provider.
 *
 * Priority `20` places monitoring in the `observability` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Monitoring', priority: 20)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
