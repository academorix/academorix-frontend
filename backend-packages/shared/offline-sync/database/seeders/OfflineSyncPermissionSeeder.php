...
/**
 * Seed the {@see OfflineSyncPermission} cases into spatie/laravel-permission's
 * `permissions` table.
 *
...
final class OfflineSyncPermissionSeeder extends Seeder
{
    ...
    {
        return [OfflineSyncPermission::class];
    }
}
