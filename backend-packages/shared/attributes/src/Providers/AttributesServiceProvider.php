...
/**
 * @file modules/shared/attributes/src/Providers/AttributesServiceProvider.php
 *
 * @description
 * Root service provider for the Attributes domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AttributesPermissionSeeder` — projects `AttributesPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Attributes\Providers;
 ...
 *
 * Priority `15` places attributes in the `shared` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Attributes', priority: 15)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
