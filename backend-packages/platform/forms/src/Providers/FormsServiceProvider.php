...
/**
 * @file modules/platform/forms/src/Providers/FormsServiceProvider.php
 *
 * @description
 * Root service provider for the Forms domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `FormsPermissionSeeder` — projects `FormsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Forms\Providers;
...
/**
 * Forms module service provider.
 *
 * Priority `12` places forms in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Forms', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
