...
/**
 * @file modules/platform/teams/src/Providers/TeamsServiceProvider.php
 *
 * @description
 * Root service provider for the Teams domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `TeamsPermissionSeeder` — projects `TeamsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Teams\Providers;
...
/**
 * Teams module service provider.
 *
 * Priority `12` places teams in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Teams', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
