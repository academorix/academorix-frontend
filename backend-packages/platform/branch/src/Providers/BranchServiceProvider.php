...
/**
 * @file modules/platform/branch/src/Providers/BranchServiceProvider.php
 *
 * @description
 * Root service provider for the Branch domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `BranchPermissionSeeder` — projects `BranchPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Branch\Providers;
...
/**
 * Branch module service provider.
 *
 * Priority `12` places branch in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Branch', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
