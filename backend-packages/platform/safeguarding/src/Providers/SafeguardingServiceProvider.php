...
/**
 * @file modules/platform/safeguarding/src/Providers/SafeguardingServiceProvider.php
 *
 * @description
 * Root service provider for the Safeguarding domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `SafeguardingPermissionSeeder` — projects `SafeguardingPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Safeguarding\Providers;
...
/**
 * Safeguarding module service provider.
 *
 * Priority `12` places safeguarding in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Safeguarding', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class SafeguardingServiceProvider extends ServiceProvider
{
}
