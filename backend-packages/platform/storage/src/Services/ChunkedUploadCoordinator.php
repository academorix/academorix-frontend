...
/**
 * Concrete service — ChunkedUploadCoordinator.
 *
 * Implements {@see ChunkedUploadCoordinatorInterface}. `#[Scoped]` because most
 ...
 */
#[Scoped]
final class ChunkedUploadCoordinator implements ChunkedUploadCoordinatorInterface
{
    /**
