...
/**
 * @file modules/platform/ai/src/Providers/AiServiceProvider.php
 *
 * @description
 * Root service provider for the Ai domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AiPermissionSeeder` — projects `AiPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Ai\Providers;
...
/**
 * Ai module service provider.
 *
 * Priority `12` places ai in the `platform` tier
