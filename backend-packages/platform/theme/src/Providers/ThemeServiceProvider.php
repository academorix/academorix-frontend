...
/**
 * @file modules/platform/theme/src/Providers/ThemeServiceProvider.php
 *
 * @description
 * Root service provider for the Theme domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `ThemePermissionSeeder` — projects `ThemePermission` cases into spatie/laravel-permission.
...
namespace Academorix\Theme\Providers;
...
/**
 * Theme module service provider.
 *
 * Priority `12` places theme in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Theme', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
