...
/**
 * @file modules/platform/reception/src/Providers/ReceptionServiceProvider.php
 *
 * @description
 * Root service provider for the Reception domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `ReceptionPermissionSeeder` — projects `ReceptionPermission` cases into spatie/laravel-permission.
...
/**
 * Reception module service provider.
 *
 * Priority `12` places reception in the `platform` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Reception', priority: 12)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
