...
/**
 * `PATCH /api/v1/platform/business-types/{id}` — update action (platform-admin audience).
 *
 ...
 * @since    0.1.0
 */
#[AsAction(name: 'application.business_types.update')]
#[Patch('/api/v1/platform/business-types/{id}')]
#[Middleware(['api', 'auth:sanctum', 'platform_admin'])]
final class UpdateBusinessTypeAction
{
    use AsController;
