...
A modern, powerful enum system for PHP 8.1+ that extends native enums with
helpful traits and metadata support.
...
The enum system is part of the Framework package. Simply use the `Enum` trait in
your enums.
