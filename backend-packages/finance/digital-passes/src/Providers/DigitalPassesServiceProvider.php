...
/**
 * @file modules/finance/digital-passes/src/Providers/DigitalPassesServiceProvider.php
 *
 * @description
 * Root service provider for the DigitalPasses domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `DigitalPassesPermissionSeeder` — projects `DigitalPassesPermission` cases into spatie/laravel-permission.
...
namespace Academorix\DigitalPasses\Providers;
...
/**
 * DigitalPasses module service provider.
 *
 * Priority `30` places digital-passes in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'DigitalPasses', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class DigitalPassesServiceProvider extends ServiceProvider
{
}
