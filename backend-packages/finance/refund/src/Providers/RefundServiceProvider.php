...
/**
 * @file modules/finance/refund/src/Providers/RefundServiceProvider.php
 *
 * @description
 * Root service provider for the Refund domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `RefundPermissionSeeder` — projects `RefundPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Refund\Providers;
...
/**
 * Refund module service provider.
 *
 * Priority `30` places refund in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Refund', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class RefundServiceProvider extends ServiceProvider
{
}
