...
/**
 * @file modules/finance/chargeback/src/Providers/ChargebackServiceProvider.php
 *
 * @description
 * Root service provider for the Chargeback domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `ChargebackPermissionSeeder` — projects `ChargebackPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Chargeback\Providers;
...
/**
 * Chargeback module service provider.
 *
 * Priority `30` places chargeback in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Chargeback', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
