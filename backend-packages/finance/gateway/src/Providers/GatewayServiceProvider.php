...
/**
 * @file modules/finance/gateway/src/Providers/GatewayServiceProvider.php
 *
 * @description
 * Root service provider for the Gateway domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `GatewayPermissionSeeder` — projects `GatewayPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Gateway\Providers;
...
/**
 * Gateway module service provider.
 *
 * Priority `30` places gateway in the `finance` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Gateway', priority: 30)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
