...
/**
 * @file modules/sports/athlete-guardian/src/Providers/AthleteGuardianServiceProvider.php
 *
 * @description
 * Root service provider for the AthleteGuardian domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AthleteGuardianPermissionSeeder` — projects `AthleteGuardianPermission` cases into spatie/laravel-permission.
...
namespace Academorix\AthleteGuardian\Providers;
...
/**
 * AthleteGuardian module service provider.
 *
 * Priority `40` places athlete-guardian in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'AthleteGuardian', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class AthleteGuardianServiceProvider extends ServiceProvider
{
}
