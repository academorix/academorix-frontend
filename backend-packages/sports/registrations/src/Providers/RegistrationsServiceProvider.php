...
/**
 * @file modules/sports/registrations/src/Providers/RegistrationsServiceProvider.php
 *
 * @description
 * Root service provider for the Registrations domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `RegistrationsPermissionSeeder` — projects `RegistrationsPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Registrations\Providers;
...
/**
 * Registrations module service provider.
 *
 * Priority `40` places registrations in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Registrations', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class RegistrationsServiceProvider extends ServiceProvider
{
}
