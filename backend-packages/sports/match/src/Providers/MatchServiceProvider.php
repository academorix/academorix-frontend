...
/**
 * @file modules/sports/match/src/Providers/MatchServiceProvider.php
 *
 * @description
 * Root service provider for the Match domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `MatchPermissionSeeder` — projects `MatchPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Match\Providers;
...
/**
 * Match module service provider.
 *
 * Priority `40` places match in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Match', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
