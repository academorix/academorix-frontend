...
/**
 * @file modules/sports/competition/src/Providers/CompetitionServiceProvider.php
 *
 * @description
 * Root service provider for the Competition domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `CompetitionPermissionSeeder` — projects `CompetitionPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Competition\Providers;
...
/**
 * Competition module service provider.
 *
 * Priority `40` places competition in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Competition', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
