 ...
 * @since    0.1.0
 */
#[AsAction(name: 'progress.coach_notes.list')]
#[Get('/api/v1/coach-notes')]
#[Middleware(['api', 'auth:sanctum', 'tenant.resolve'])]
final class ListCoachNoteAction
{
    use AsController;
    ...
    /**
     * List `coach-notes` for the current caller.
     *
     ...
     *
     * @return PaginatedDataCollection<int, CoachNoteData>  Paginated wire-visible DTOs.
     */
    public function __invoke(Request $request): PaginatedDataCollection
    {
        ...
        return CoachNoteData::collect($page, PaginatedDataCollection::class);
    }
}
