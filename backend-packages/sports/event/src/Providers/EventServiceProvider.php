...
/**
 * @file modules/sports/event/src/Providers/EventServiceProvider.php
 *
 * @description
 * Root service provider for the Event domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `EventPermissionSeeder` — projects `EventPermission` cases into spatie/laravel-permission.
...
namespace Academorix\Event\Providers;
...
/**
 * Event module service provider.
 *
 * Priority `40` places event in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Event', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
