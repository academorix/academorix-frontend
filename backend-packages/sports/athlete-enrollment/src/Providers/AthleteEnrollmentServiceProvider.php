...
/**
 * @file modules/sports/athlete-enrollment/src/Providers/AthleteEnrollmentServiceProvider.php
 *
 * @description
 * Root service provider for the AthleteEnrollment domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AthleteEnrollmentPermissionSeeder` — projects `AthleteEnrollmentPermission` cases into spatie/laravel-permission.
...
namespace Academorix\AthleteEnrollment\Providers;
...
/**
 * AthleteEnrollment module service provider.
 *
 * Priority `40` places athlete-enrollment in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'AthleteEnrollment', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
...
final class AthleteEnrollmentServiceProvider extends ServiceProvider
{
}
