...
/**
 * @file modules/sports/attendance/src/Providers/AttendanceServiceProvider.php
 *
 * @description
 * Root service provider for the Attendance domain module —
 ...
 *   - Seeder: `#[AsSeeder]` on `AttendancePermissionSeeder` — projects `AttendancePermission` cases into spatie/laravel-permission.
...
namespace Academorix\Attendance\Providers;
...
/**
 * Attendance module service provider.
 *
 * Priority `40` places attendance in the `sports` tier
 ...
 * @since    0.1.0
 */
#[AsModule(name: 'Attendance', priority: 40)]
#[LoadsResources(
    config: true,
    migrations: true,
    commands: true,
