...
Stackra Commerce service — SaaS billing + entitlements. Owns TenantSubscription (Paddle mirror, coupons, chargebacks) and Entitlements (feature flags, slot quotas, token pools). Co-located so provisioning atomicity holds. SHARED across every Application.
...
- `docs/services.md` — the six-service split; this is `stackra-commerce`.
