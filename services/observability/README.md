...
Stackra Observability service — audit + activity + monitoring + compliance evidence + retention. SHARED across every Application. Delivers the two-signal split (compliance audit vs. product activity) plus the retention runner.
...
- `docs/services.md` — the six-service split; this is `stackra-observability`.
